...
import { Search, Plus, Trash2, Edit2, ShieldCheck, Tag, Info } from "lucide-react";
    ...
    <div className="flex h-full flex-col gap-6">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between border-b border-slate-200 pb-6 gap-4">
        ...
        <div className="flex gap-2">
           ...
           {isAdmin && (
             <button className="flex items-center gap-2 bg-slate-900 text-white px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-black transition shadow-lg shadow-slate-900/20 active:scale-95">
                         ...
                         {isAdmin && (
                           <>
                             ...
                             <button 
                                ...
                                className={`p-2 transition-colors rounded-lg ${item.isSystemDefault ? 'text-slate-200 cursor-not-allowed' : 'text-slate-400 hover:text-rose-600 hover:bg-rose-50'}`}
